...
public class DrivingRouteOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        if (mRouteLine == null) return null;
            ...
            for (DrivingRouteLine.DrivingStep step : mRouteLine.getAllStep()) {
                ...
                if (step.getEntrance() != null) {
                    overlayOptionses.add((new MarkerOptions())
                            ...
                            .icon(BitmapDescriptorFactory.fromAssetWithDpi("icon_line_sorrow.png")));
                }
                // 最后路段绘制出口点
...
//            }
            ...
            if (traffics.size() > 0) isDotLine = true;
            ...
            if (isDotLine) option.customTextureList(getCustomTextureList());
